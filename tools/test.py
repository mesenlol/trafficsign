...
def make_parser():
    ...
    parser.add_argument("-se", "--start_epoch", default=20, type=int) # 可以指定多个权重验证，从start_epoch到end_epoch
    parser.add_argument("-ee", "--end_epoch", default=23, type=int)
    return parser
...
#         cocoEval.summarize()
        ...
        cocoEval.accumulate()
        print("===================================The cls1 MAP:========================================")
        cocoEval.summarize()  # 在summarize里面执行打印操作
        ...
        # 分别打印所有类map
        cocoEval.params.catIds = [0, 1, 2, 3, 4]
        cocoEval.evaluate()
        cocoEval.accumulate()
        print("===================================The Allcls MAP:========================================")
        cocoEval.summarize()
